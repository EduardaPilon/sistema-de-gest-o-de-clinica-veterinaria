 ...
 * @author eduar
 */
public class EditarTutor extends javax.swing.JDialog {
     ...
     */
    public EditarTutor(JDialog parent, boolean modal, Controle controle, Tutor tutor) {
        super(parent, modal);
        initComponents();
    ...
    private void btnSalvar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvar1ActionPerformed
        ...
        if(tfNome.getText().trim().isEmpty() || tfTelefone.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(this, "Os campos não podem ficar vazio", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }
        tutor.setNome(tfNome.getText().trim());
        tutor.setTelefone(tfTelefone.getText().trim());
        
        JOptionPane.showMessageDialog(this, "Tutor alterado com secesso", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
        this.dispose();
